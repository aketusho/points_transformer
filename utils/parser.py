...
def get_args():
    ...
    parser.add_argument('--ckpts', type = str, default="./experiments/pretrain/cfgs/ScanObjectNN/ckpt-last.pth", help = 'test used ckpt path')#
    ...
    # if pretrain, False, otherwise True
